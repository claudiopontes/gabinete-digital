      ...
      <div className="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        ...
        <div className="flex w-full items-center justify-between gap-2 border-b border-gray-200 px-3 py-3 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <Link href="/" className="lg:hidden">
            <Image width={154} height={32} className="dark:hidden" src="./images/logo/logo.svg" alt="Logo" style={{ width: "154px", height: "auto" }} />
            <Image width={154} height={32} className="hidden dark:block" src="./images/logo/logo-dark.svg" alt="Logo" style={{ width: "154px", height: "auto" }} />
          </Link>
